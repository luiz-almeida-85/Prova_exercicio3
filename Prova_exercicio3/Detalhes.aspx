<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Detalhes.aspx.cs" Inherits="Prova_exercicio3.Detalhes" %>
        ...
        <div>
            ...
            <div class="container">
                ...
                <div class="row" style="padding-top: 15px">
                    ...
                    <div class="col-md-12">
                        <label>Curso: </label>
                        <asp:TextBox ID="txtCurso" runat="server" MaxLength="10" CssClass="form-control"
                            Enabled="false"></asp:TextBox>
                    </div>
                </div>
            </div>
